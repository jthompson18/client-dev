...
// Selector options
var singleSelectOptions = [{ id: 6, text: "2013" }, { id: 5, text: "2012" }, { id: 4, text: "2011" }, { id: 3, text: "2010" }, { id: 2, text: "2008" }, { id: 1, text: "2005" }, { id: 0, text: "2000" }];
var multiSelectOptions = [{ id: "unitedStates", text: "United States" }, { id: "cuba", text: "Cuba" }, { id: "poland", text: "Poland" }, { id: "libya", text: "Libya" }, { id: "malaysia", text: "Malaysia" }, { id: "congo", text: "Congo" }];
...
function updateChartData(data) {
    ...
    for (var i = 0; i < numOfDisplayCountries; i++) {
        ...
        updatedData.push({ name: data[ref].name, data: data[ref].hdi, color: data[ref].color });
    }
...
function updateChart() {
    ...
    for (var i = 0; i < numOfDisplayCountries; i++) {
        ...
        var ref = displayCountryIds[i];
        chart.addSeries(chartDisplayData[i], shouldRedraw);
    }
}
...
},{"highcharts-browserify":3,"jquery":5,"jquery.mousewheel":4,"select2":6}],2:[function(require,module,exports){
...
},{"./adapters/standalone-framework":2}],4:[function(require,module,exports){
...
},{"jquery":5,"jquery.mousewheel":4}]},{},[1]);
